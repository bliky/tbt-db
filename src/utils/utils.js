...
const routData = {
  ...
  branchCore: { url: baseUrl + '/bdc-prd-dbd/branch-core', title:'核心指标' },
  branchCommon: { url: baseUrl + '/bdc-prd-dbd/branch-common', title:'常用指标' },
  branchGmv: { url: baseUrl + '/bdc-prd-dbd/branch-gmv', title:'实时GMV' },
