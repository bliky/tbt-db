<template>
  <div v-show="isShow" class="pop-pannel" style="top: 104px; z-index: 200; border-top: 1px solid #F6F6F6;" @click="hide">
    <div class="pop-pannel-bd branch" @click.stop=''>
      ...
      <area-filter ref="areaFilter" v-show="showMore && tabIdx == 1" @change="onAreaChange"></area-filter>
      <city-filter ref="cityFilter" v-show="!showMore" @change="onCityChange"></city-filter>
